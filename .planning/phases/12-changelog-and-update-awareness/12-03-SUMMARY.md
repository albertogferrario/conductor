...
provides:
  - /dev:whats-new command for version comparison
...
**/dev:whats-new command created for users to discover changes since their installed version, with VERSION file written during installation and help documentation updated**
...
## Accomplishments
- Created /dev:whats-new command with remote changelog fetch
...
- /dev:whats-new command ready for users to discover updates
