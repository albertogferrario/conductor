...
This document explains how Conductor is written so future Claude instances can contribute consistently.

## Core Philosophy

Conductor is a **meta-prompting system** where every file is both implementation and specification. Files teach Claude how to build software systematically. The system optimizes for:
...
### Slash Commands (`commands/conductor/*.md`)
...
### Workflows (`conductor/workflows/*.md`)
...
### Templates (`conductor/templates/*.md`)
...
### References (`conductor/references/*.md`)
