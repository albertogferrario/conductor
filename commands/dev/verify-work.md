...
Output: {phase}-UAT.md tracking all test results, issues logged for /dev:plan-fix
</objective>

<execution_context>
@~/.claude/conductor/workflows/verify-work.md
@~/.claude/conductor/templates/UAT.md
</execution_context>
...
- Don't fix issues during testing — log for /dev:plan-fix
</anti_patterns>
