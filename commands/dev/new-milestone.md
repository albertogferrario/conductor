...
<execution_context>
@~/.claude/conductor/workflows/create-milestone.md
@~/.claude/conductor/templates/roadmap.md
</execution_context>
...
4. Gather phases (per depth setting: quick 3-5, standard 5-8, comprehensive 8-12):
   - If called from /dev:discuss-milestone, use provided context
