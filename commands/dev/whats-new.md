...
```bash
cat ~/.claude/conductor/VERSION 2>/dev/null
```

**If VERSION file missing:**
```
## Conductor What's New

**Installed version:** Unknown

Your installation doesn't include version tracking.

**To fix:** `npx conductor-cc --global`
...
- URL: `https://raw.githubusercontent.com/glittercowboy/conductor/main/CHANGELOG.md`
...
```bash
cat ~/.claude/conductor/CHANGELOG.md 2>/dev/null
```
...
[View full changelog](https://github.com/glittercowboy/conductor/blob/main/CHANGELOG.md)
```
...
**To update:** `npx conductor-cc --global`
```
