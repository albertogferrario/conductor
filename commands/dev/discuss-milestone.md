...
Output: Context gathered, then routes to /dev:new-milestone
</objective>

<execution_context>
@~/.claude/conductor/workflows/discuss-milestone.md
</execution_context>
...
4. Hand off to /dev:new-milestone with gathered context
