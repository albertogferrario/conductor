...
<execution_context>
@~/.claude/conductor/workflows/map-codebase.md
@~/.claude/conductor/templates/codebase/stack.md
@~/.claude/conductor/templates/codebase/architecture.md
@~/.claude/conductor/templates/codebase/structure.md
@~/.claude/conductor/templates/codebase/conventions.md
@~/.claude/conductor/templates/codebase/testing.md
@~/.claude/conductor/templates/codebase/integrations.md
@~/.claude/conductor/templates/codebase/concerns.md
</execution_context>
