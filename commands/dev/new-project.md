...
@~/.claude/conductor/references/principles.md
@~/.claude/conductor/references/questioning.md
@~/.claude/conductor/templates/project.md
@~/.claude/conductor/templates/config.json
...
Present completion with next steps (see ~/.claude/conductor/references/continuation-format.md):
