...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /dev:research-phase instead, which produces RESEARCH.md.
</purpose>
...
See ~/.claude/conductor/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Quality check:** Before finalizing findings, consult ~/.claude/conductor/references/research-pitfalls.md to avoid common research gaps.

7. **Create DISCOVERY.md** using ~/.claude/conductor/templates/discovery.md structure:
...
1. **Scope the discovery** using ~/.claude/conductor/templates/discovery.md:
...
6. **Quality check:** Before finalizing findings, consult ~/.claude/conductor/references/research-pitfalls.md to ensure comprehensive coverage and avoid common research gaps.

7. **Create comprehensive DISCOVERY.md:**

   - Full structure from ~/.claude/conductor/templates/discovery.md
...
Use ~/.claude/conductor/templates/discovery.md.
...
1. Discuss phase context (/dev:discuss-phase [current-phase])
2. Create phase plan (/dev:plan-phase [current-phase])
