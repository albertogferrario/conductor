...
See ~/.claude/conductor/references/checkpoints.md for complete checkpoint guidance.
</step>
...
@~/.claude/conductor/templates/checkpoint-return.md
...
Create `.planning/phases/XX-name/{phase}-USER-SETUP.md` using template from `~/.claude/conductor/templates/user-setup.md`.
...
Use ~/.claude/conductor/templates/summary.md for structure.
...
For commit message conventions, see ~/.claude/conductor/references/git-integration.md
</step>
