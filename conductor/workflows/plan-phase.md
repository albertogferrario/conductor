...
1. ~/.claude/conductor/templates/phase-prompt.md
2. ~/.claude/conductor/references/plan-format.md
3. ~/.claude/conductor/references/scope-estimation.md
4. ~/.claude/conductor/references/checkpoints.md
5. ~/.claude/conductor/references/tdd.md
...
See `~/.claude/conductor/references/tdd.md` for TDD plan structure.
...
See ~/.claude/conductor/references/checkpoints.md for checkpoint structure.
...
See ~/.claude/conductor/references/scope-estimation.md for complete guidance.
</step>
...
Use template from `~/.claude/conductor/templates/phase-prompt.md`.
...
```markdown
<execution_context>
@~/.claude/conductor/workflows/execute-plan.md
@~/.claude/conductor/templates/summary.md
@~/.claude/conductor/references/checkpoints.md
</execution_context>
```
...
**TDD candidates get dedicated plans.** If "Create price calculator with discount rules" warrants TDD, create a TDD plan for it. See `~/.claude/conductor/references/tdd.md` for TDD plan structure.
</task_quality>
