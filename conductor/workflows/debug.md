...
<references>
@~/.claude/conductor/references/debugging/debugging-mindset.md
@~/.claude/conductor/references/debugging/hypothesis-testing.md
@~/.claude/conductor/references/debugging/investigation-techniques.md
@~/.claude/conductor/references/debugging/verification-patterns.md
@~/.claude/conductor/references/debugging/when-to-research.md
</references>

<template>
@~/.claude/conductor/templates/DEBUG.md
</template>
